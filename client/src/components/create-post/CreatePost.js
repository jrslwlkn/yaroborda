    ...
    form = (
      <Draggable>
        <article id="drag" className="mw5 mw6-ns absolute ba bg-white">
          ...
          Add a post
            <button type="button" className="pointer fr pa0 ph1 mb1 bg-purple white">x</button>
          </div>
          <div className="pa3 bt">
            <form method="POST" onSubmit="http://localhost:5000/upload" encType="multipart/form-data">
